...
public class MyRESTController {
	...
	public ResponseEntity<List<Contact>> getContactBasesOnKeyword(@PathVariable(value = "keyword" String keyword) {

		try {
	    List<Contacts> list=  repository.findUsersByKeyword(keyword);
		}
		catch(Exception e){
			System.out.println(e.getMessage());
		}
